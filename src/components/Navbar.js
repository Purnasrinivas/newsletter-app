    ...
    <nav className="navbar">
      <div className="container navbar-container">
        ...
        <div className={`navbar-menu ${isMenuOpen ? 'is-open' : ''}`}>
          <Link to="/jobs" className={`navbar-item ${isActive('/jobs') ? 'active' : ''}`}>
          ...
          <Link to="/newsletter" className={`navbar-item ${isActive('/newsletter') ? 'active' : ''}`}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link to="/post-job" className={`navbar-item ${isActive('/post-job') ? 'active' : ''}`}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 5V19M5 12H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Post Job
          </Link>
          <Link to="/subscribe" className={`navbar-item ${isActive('/subscribe') ? 'active' : ''}`}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
